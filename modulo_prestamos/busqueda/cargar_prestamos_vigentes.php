...
WHERE prestamo.fecha_entrega >= CURDATE() AND 
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '                    <div class="card-header bg-success text-light"><i class="fas fa-info-circle"></i> Préstamo</div>';
        $output['data'] .= '                    <div class="card-body">';
        $output['data'] .= '                        <h6 class="card-title d-inline fw-normal">Fecha de Préstamo: </h6>';
        $output['data'] .= '                        <h6 class="card-text d-inline ml-2 text-success">';
        ...
        $output['data'] .= '                                    <li class="list-group-item bg-success text-light mt-2" aria-current="true">';
        ...
        $output['data'] .= '                                <div class="ms-1 text-end mt-3">
                                                                <a href="#" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="Ver más detalles" data-bs-toggle="modal" data-bs-target="#confirmacionModal" data-bs-id="' . $row['id_prestamo'] . '">
