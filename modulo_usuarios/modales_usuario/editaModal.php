...
<div class="modal fade" id="editaModal_usuarios" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editaModal_usuarios_label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h1 class="modal-title fs-5 text-light" id="editaModal_usuarios_label"><i class="fa-solid fa-user-pen"></i> Editar usuario</h1>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form class="needs-validation" action="edita_u.php" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5 col-xl-4 ">
                                <div class="input-group input-group-sm mb-2">
                                    ...
                                    <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno" required oninput="this.value = this.value.toUpperCase()">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-12 col-md-5 col-xl-4">
                                <div class="input-group input-group-sm mb-2">
                                    ...
                                    <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" required oninput="this.value = this.value.toUpperCase()">
                                    <div class="invalid-feedback">
                                        Por favor, escribe un apellido Paterno.
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-7 col-xl-7 pt-2">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                        Por favor, escribe un correo electónico.
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="col-12 col-md-12 col-xl-12 pt-2">
                                <div class="mb-3">
                                    <label for="perfil" class="form-label">Imagen de perfil:</label>
                                    <input class="form-control form-control-sm" id="perfil" name="perfil" type="file" accept="image/jpeg" required>
                                </div>
                            </div> -->
